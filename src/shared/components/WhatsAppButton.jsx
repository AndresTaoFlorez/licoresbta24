...
const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 flex justify-center items-center p-4">
      {/* <button
      ...
      {/* Alternative fixed position button (uncomment to use) */}
      ...
      >
        ...
        <p className="text-md text-center [@media(max-width:431px)]:hidden">Pedir por WhatsApp</p>
      </button>
